...
public static class TextDB
{
    ...
    public static string[] DeliveryTitles = {
        "Book Delivery",
        "Cosmetics Delivery",
        "Love Letter",
        "Clothing Delivery",
